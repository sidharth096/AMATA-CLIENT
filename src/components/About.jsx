  ...
  return (
    <div className="bg-[#f5f5ef] py-8">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-8">
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs text-gray-600">Purely Advanced Milking</span>
            </div>
            <div className="flex flex-col items-center">
      ...
      <div className="relative max-w-6xl mx-auto bg-white rounded-t-[50%] rounded-b-2xl shadow p-8 pt-20 pb-16 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none" style={{ background: "url('/path/to/bg.svg') center/cover no-repeat" }} />
        {/* Title */}
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 flex flex-col items-center">
            <div className="relative">
              <img src={bottleImg} alt="A2 Milk Bottle" className="w-32 h-48 object-contain z-10 relative" />
        ...
        <div className="flex flex-col md:flex-row items-end gap-8 mt-10">
          {/* Cow Image */}
          <div className="flex-1 flex justify-center">
            <img src={cowImg} alt="Gir Cow" className="w-56 h-40 object-cover rounded-[40%] shadow-lg" />
          </div>
          {/* Practices */}
          <div className="flex-1">
            <h3 className="text-xl font-bold mb-2">Traditional and Ethical Practices</h3>
